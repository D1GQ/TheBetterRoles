...
{
    /**********Check Game Status***********/
    public static bool IsDev => EOSManager.Instance?.userId != null && Main.DevUser.Contains($"{Utils.GetHashStr(EOSManager.Instance.userId.ToString())}+{Utils.GetHashStr(EOSManager.Instance.friendCode)}");
