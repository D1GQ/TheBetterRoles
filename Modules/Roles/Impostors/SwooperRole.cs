    ...
    public override BetterOptionItem[]? OptionItems
    {
        get
        {
            ...
            [
                ...
                InvisibilityDuration = new BetterOptionFloatItem().Create(GetOptionUID(), SettingsTab, Translator.GetString("Role.Swooper.Option.InvisibilityDuration"), [0f, 180f, 2.5f], 10f, "", "s", RoleOptionItem),
            ];
        }
    }
